...
public class UserMapper {
    ...
    public static UserDTO toUserDTO(UserCredential user) {
        if (user == null) {
            return null;
        }
        return new UserDTO(
    ...
    public static UserCredential toUser(UserDTO dto) {
        if (dto == null) {
            return null;
        }
    ...
    public static List<UserDTO> toUserDTOList(List<UserCredential> users) {
        if (users == null) {
            return List.of();
        }
        return users.stream()
